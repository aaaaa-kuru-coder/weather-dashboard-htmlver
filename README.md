...
- 気温・降水確率の線幅をおおむね従来の 2/3 に縮小しました。
- 降水量の四角マーカーも一辺がおおむね従来の 2/3 になるよう縮小しました。
- 最高・最低気温、最大降水確率などのグラフ内注記は従来の約 1.8 倍のフォントサイズに拡大しました。
- 系列凡例と降水量・雷凡例を、普段は閉じている「凡例」details に統合しました。
- 凡例を3列構成にし、左列に気温・降水確率系列、中央列に～1mm～～7mm、右列に～10mm～40mm～と雷予報を配置しました。
